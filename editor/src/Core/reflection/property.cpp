...
namespace Engine::Refl
{
	...
	static void on_init()
	{
		ScriptNamespaceScopedChanger changer("Engine::Actor");
		auto renderer = ScriptEngine::register_function("bool render_components_element(Engine::Object@, "
		...
		prop->element_property()->renderer(renderer);
