...
#define new_enum_v2(a, b) new_enum.set(#b, a##b)
	...
	static void register_functions()
	{
		...
		// e.register_function("void OpenPopup(const string& str_id, int popup_flags = 0)", ImBinder<func_of<void, const char *, ImGuiPopupFlags>(&ImGui::OpenPopup)>::bind());
		// e.register_function("void OpenPopup(unsigned int id, int popup_flags = 0)", ImBinder<func_of<void, ImGuiID, ImGuiPopupFlags>(&ImGui::OpenPopup)>::bind());
		...
		e.register_function("string TableGetColumnName(int column_n = -1)", ImBinder<func_of<const char*, int>(&ImGui::TableGetColumnName)>::bind());
		...
		// e.register_function("Ptr<ImDrawList> GetBackgroundDrawList()", ImBinder<func_of<ImDrawList *>(&ImGui::GetBackgroundDrawList)>::bind());
		// e.register_function("Ptr<ImDrawList> GetForegroundDrawList()", ImBinder<func_of<ImDrawList *>(&ImGui::GetForegroundDrawList)>::bind());
		// e.register_function("Ptr<ImDrawList> GetBackgroundDrawList(Ptr<ImGuiViewport> viewport)", ImBinder<func_of<ImDrawList *, ImGuiViewport *>(&ImGui::GetBackgroundDrawList)>::bind());
		// e.register_function("Ptr<ImDrawList> GetForegroundDrawList(Ptr<ImGuiViewport> viewport)", ImBinder<func_of<ImDrawList *, ImGuiViewport *>(&ImGui::GetForegroundDrawList)>::bind());
		// e.register_function("bool IsRectVisible(const ImVec2 & size)", ImBinder<func_of<bool, const ImVec2 &>(&ImGui::IsRectVisible)>::bind());
		// e.register_function("bool IsRectVisible(const ImVec2 & rect_min, const ImVec2 & rect_max)", ImBinder<func_of<bool, const ImVec2 &, const ImVec2 &>(&ImGui::IsRectVisible)>::bind());
		...
		// e.register_function("bool ListBox(const string& label, Ptr<int> current_item, Ptr<**)> old_callback, Ptr<void> user_data, int items_count, int height_in_items)", ImBinder<func_of<bool, const char *, int *, bool (*)(void *, int, const char **), void *, int, int>(&ImGui::ListBox)>::bind());
		// e.register_function("bool Combo(const string& label, Ptr<int> current_item, Ptr<**)> old_callback, Ptr<void> user_data, int items_count, int popup_max_height_in_items)", ImBinder<func_of<bool, const char *, int *, bool (*)(void *, int, const char **), void *, int, int>(&ImGui::Combo)>::bind());
		...
		// e.register_function("bool ImageButton(ImTextureID user_texture_id, const ImVec2 & size, const ImVec2 & uv0, const ImVec2 & uv1, int frame_padding, const ImVec4 & bg_col, const ImVec4 & tint_col)", ImBinder<func_of<bool, ImTextureID, const ImVec2 &, const ImVec2 &, const ImVec2 &, int, const ImVec4 &, const ImVec4 &>(&ImGui::ImageButton)>::bind());
