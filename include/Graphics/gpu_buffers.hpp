...
namespace Trinex
{
	...
	public:
		...
		// clang-format off
		VertexBufferBase(RHIBufferFlags type, u16 stride, usize count, const void* data = nullptr, bool keep_cpu_data = false);
		...
		VertexBufferBase& init(RHIBufferFlags type, usize stride, usize count, const void* data = nullptr, bool keep_cpu_data = false);
		// clang-format on

		VertexBufferBase& init(bool keep_cpu_data = false);
		u8* allocate_data(RHIBufferFlags type, u16 stride, usize count);
	...
	public:
		...
		VertexBuffer(RHIBufferFlags type, usize count, const T* data = nullptr, bool keep_cpu_data = false)
		...
		inline VertexBuffer& init(RHIBufferFlags type, usize count, const T* data = nullptr, bool keep_cpu_data = false)
		{
		...
		inline T* allocate_data(RHIBufferFlags type, usize size)
		{
	...
	public:
		...
		IndexBuffer& init(RHIBufferFlags type, usize count, const u16* data = nullptr, bool keep_cpu_data = false);
		IndexBuffer& init(RHIBufferFlags type, usize count, const u32* data = nullptr, bool keep_cpu_data = false);
		IndexBuffer& init(bool keep_cpu_data = false);
		u8* allocate_data(RHIBufferFlags type, RHIIndexFormat format, usize count);
		IndexBuffer& release();
	...
	public:
		...
		TypedIndexBuffer(RHIBufferFlags type, usize count, const T* data = nullptr, bool keep_cpu_data = false)
		...
		TypedIndexBuffer& init(RHIBufferFlags type, usize count, const T* data = nullptr, bool keep_cpu_data = false)
		{
		...
		T* allocate_data(RHIBufferFlags type, usize count)
		{
