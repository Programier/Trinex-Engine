...
namespace Engine
{
    ...
    public:
        ...
        class ENGINE_EXPORT IdentifiedObject
        {
        public:
        ...
        class ENGINE_EXPORT Pin : public IdentifiedObject
        {
        private:
            Node* m_node;
            Name m_name;
        ...
        public:
            ...
            Expression expression_cast(const Expression& in_expression, VisualMaterial::PinType out_type);
        ...
        class ENGINE_EXPORT Node : public IdentifiedObject
        {
        protected:
        ...
        public:
            ...
            virtual Node& init(VisualMaterial* material);
    ...
    public:
        ...
        Node* create_node(class Struct* node_struct);
