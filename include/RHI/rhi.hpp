...
namespace Trinex
{
	...
	public:
		...
		virtual RHIShader* create_shader(Span<u8> source, Span<RHIShaderParameterInfo> parameters) = 0;
		...
		virtual RHISwapchain* create_swapchain(Window* window, u32 present_interval)               = 0;
