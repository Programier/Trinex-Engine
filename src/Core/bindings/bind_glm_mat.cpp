	...
	static void on_init()
	{
...

		{
			...
			ScriptClassRegistrar registrar = ScriptClassRegistrar::value_class(
					class_name + "4f", sizeof(Matrix4fWrapper), info_of<Matrix4fWrapper>());
		...
		}
		{
			...
			ScriptClassRegistrar registrar = ScriptClassRegistrar::value_class(
					class_name + "3f", sizeof(Matrix3fWrapper), info_of<Matrix3fWrapper>());
		...
		}
		{
			...
			ScriptClassRegistrar registrar = ScriptClassRegistrar::value_class(
					class_name + "2f", sizeof(Matrix2fWrapper), info_of<Matrix2fWrapper>());
