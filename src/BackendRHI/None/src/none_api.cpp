...
namespace Engine
{
	...
	RHI_Texture* NoneApi::create_texture_2d(RHIColorFormat format, Vector2u size, uint32_t mips, RHITextureCreateFlags flags)
	{
	...
	NoneApi& NoneApi::update_texture_2d(RHI_Texture*, byte mip, const RHIRect& rect, const byte* data, size_t data_size)
	{
		return *this;
	}
