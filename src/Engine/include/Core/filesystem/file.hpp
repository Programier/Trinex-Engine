...
namespace Engine::VFS
{
    ...
    public:
        ...
        virtual FilePosition seek_read(FileOffset offset, FileSeekDir dir)  = 0;
        virtual FilePosition tell_read()                                    = 0;
        virtual FilePosition seek_write(FileOffset offset, FileSeekDir dir) = 0;
        virtual FilePosition tell_write()                                   = 0;
