...
public:
    ...
    {
        Engine::global_config.load(Engine::Path(Engine::ConfigManager::get_string("Engine::config_dir")) /
                                   Engine::Path("editor.json"));
...
static void on_init()
{
    Engine::Arguments::push_argument(Engine::Arguments::Argument("engine", "EditorEngine"));
}
