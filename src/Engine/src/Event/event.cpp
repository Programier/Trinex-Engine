...
namespace Engine
{
    ...
    implement_enum(EventType, Engine, {"Quit", EventType::Quit}, {"AppTerminating", EventType::AppTerminating},
                   ...
                   {"AppDidEnterForeground", EventType::AppDidEnterForeground}, {"DisplayAdded", EventType::DisplayAdded},
                   ...
                   {"WindowClose", EventType::WindowClose}, {"WindowTakeFocus", EventType::WindowTakeFocus},
