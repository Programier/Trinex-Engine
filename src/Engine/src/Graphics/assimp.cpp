...
namespace Engine
{
    namespace AssimpLibrary
    {
        ...
        static aiReturn (*assimp_get_material_string)(const aiMaterial*, const char*, unsigned int, unsigned int, aiString*) = nullptr;
        ...
        static void init_funcs()
        {
            ...
            assimp_get_material_string =
                    assimp.get<aiReturn, const aiMaterial*, const char*, unsigned int, unsigned int, aiString*>(lib_function(aiGetMaterialString));
        }
        ...
        ENGINE_EXPORT const aiScene* load_scene(const std::string& filename)
        {
            ...
            if (!assimp_load_scene)
                return nullptr;
            auto scene = assimp_load_scene(filename.c_str(), aiProcess_Triangulate | aiProcess_GenNormals | aiProcess_GenBoundingBoxes |
        ...
        ENGINE_EXPORT std::string get_material_string(const aiMaterial* material, const char* a, unsigned int b, unsigned int c)
        {
