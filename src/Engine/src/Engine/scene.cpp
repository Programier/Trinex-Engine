...
namespace Engine
{
    ...
    Scene::Scene()
    {
        ...
        m_gbuffer_to_scene_output_layer = m_base_pass_layer->create_next(SceneLayer::name_gbuffer_to_scene_output);
        m_gbuffer_to_scene_output_layer->begin_render_methods_callbacks.push_back(&SceneRenderer::begin_gbuffer_to_scene_output);
        m_gbuffer_to_scene_output_layer->end_render_methods_callbacks.push_back(&SceneRenderer::end_rendering_target);

        m_deferred_lighting_layer = m_gbuffer_to_scene_output_layer->create_next(SceneLayer::name_deferred_light_pass);
