...
namespace Engine
{
    static void on_init()
    {
        ...
        registrar.method("bool starts_with(uint8) const", method_of<bool, StringView, char>(&StringView::starts_with));
        registrar.method("bool starts_with(StringView) const", method_of<bool, StringView, StringView>(&StringView::starts_with));

        registrar.method("uint64 find(uint8, uint64 = 0) const",
                         method_of<StringView::size_type, StringView, char, StringView::size_type>(&StringView::find));
        registrar.method("uint64 find(StringView, uint64 = 0) const",
                         method_of<StringView::size_type, StringView, StringView, StringView::size_type>(&StringView::find));

        registrar.method(
                "uint64 find_first_not_of(uint8, uint64 = 0) const",
                method_of<StringView::size_type, StringView, char, StringView::size_type>(&StringView::find_first_not_of));
        registrar.method(
                "uint64 find_first_not_of(StringView, uint64 = 0) const",
                method_of<StringView::size_type, StringView, StringView, StringView::size_type>(&StringView::find_first_not_of));

        registrar.method("uint64 find_first_of(uint8, uint64 = 0) const",
                         method_of<StringView::size_type, StringView, char, StringView::size_type>(&StringView::find_first_of));
        registrar.method(
                "uint64 find_first_of(StringView, uint64 = 0) const",
                method_of<StringView::size_type, StringView, StringView, StringView::size_type>(&StringView::find_first_of));

        registrar.method(
                "uint64 find_last_not_of(uint8, uint64 = 0) const",
                method_of<StringView::size_type, StringView, char, StringView::size_type>(&StringView::find_last_not_of));
        registrar.method(
                "uint64 find_last_not_of(StringView, uint64 = 0) const",
                method_of<StringView::size_type, StringView, StringView, StringView::size_type>(&StringView::find_last_not_of));

        registrar.method("uint64 find_last_of(uint8, uint64 = 0) const",
                         method_of<StringView::size_type, StringView, char, StringView::size_type>(&StringView::find_last_of));
        registrar.method(
