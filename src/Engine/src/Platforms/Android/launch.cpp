...
FORCE_ENGINE_EXPORT extern "C" void android_main(struct android_app* application)
{
    Engine::Arguments::push_argument(Engine::Arguments::Argument("e_android_application", application));
