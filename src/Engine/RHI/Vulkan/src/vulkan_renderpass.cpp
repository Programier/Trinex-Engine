...
namespace Engine
{
        ...
        if (render_pass->has_depth_stancil)
        {
                ...
                aspect != ColorFormatAspect::DepthStencil)
            {
                throw EngineException(
                        "Cannot use attachmet with non depth-/stencil format as depth-/stencil attachment");
            }

            vk::AttachmentLoadOp clear_op = render_pass->depth_stencil_attachment.clear_on_bind
    ...
    VulkanRenderPass& VulkanRenderPass::create_attachment_references(const RenderPass* render_pass)
    {
        ...
        {
            _M_color_attachment_references.push_back(
    ...
    VulkanRenderPass& VulkanRenderPass::create()
    {
        ...
        _M_dependency = vk::SubpassDependency(0, 0, pipeline_flags, pipeline_flags, {}, access_flags,
