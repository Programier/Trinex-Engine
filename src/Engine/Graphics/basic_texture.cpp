...
namespace Engine
{
    static const std::unordered_map<TextureType, int> OpenGL_texture_type = {
            ...
            {TextureType::Texture_1D_Array, GL_TEXTURE_1D_ARRAY},
            ...
            {TextureType::Texture_Rectangle, GL_TEXTURE_RECTANGLE}};
    ...
    static const std::unordered_map<TextureParameter, int> OpenGL_texture_param = {
            ...
            {TextureParameter::Texture_Lod_Bias, GL_TEXTURE_LOD_BIAS},
